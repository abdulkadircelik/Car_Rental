              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('Açıklama', style: kSectionTitle),
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Özellikler', style: kSectionTitle),
                      const SizedBox(height: 10),
                      Row(
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Fiyat', style: kSectionTitle),
                      const SizedBox(height: 10),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: TextButton(
                  ...
                  child: const Text('Bu Arabayı Kirala'),
